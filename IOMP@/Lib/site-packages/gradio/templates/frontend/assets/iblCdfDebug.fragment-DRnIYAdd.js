...
fragmentOutputs.color =vec4(mix(colour,backgroundColour,0.5),1.0);}`;r.ShadersStoreWGSL[e]||(r.ShadersStoreWGSL[e]=t);const g={name:e,shader:t};export{g as iblCdfDebugPixelShaderWGSL};
